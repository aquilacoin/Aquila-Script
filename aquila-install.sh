...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='Aquila.conf'
CONFIGFOLDER='/root/.Aquila'
COIN_DAEMON='Aquilad'
COIN_CLI='Aquila-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CryptoNeverSleeps/Aquila-Script/releases/download/Aquila-Linux/aquila-linux-mn.tar.gz'
